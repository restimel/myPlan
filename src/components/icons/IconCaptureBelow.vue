<template>
    <svg
        ...
        viewBox="0 0 32 32"
    >
        <!-- Rectangle: existing image at top -->
        <rect x="3" y="2" width="26" height="7" rx="1" fill="none" stroke="currentColor" stroke-width="1.8"/>
        <!-- Arrow pointing up: new capture lands on bottom of existing image -->
        <path d="M12.5 14 L19.5 14 L16 10.5 Z"/>
        <!-- Camera (IconPhoto scaled to 55%, centered, positioned at bottom) -->
        <g transform="scale(0.55) translate(13.1, 25.1)">
    ...
    <!--
    Camera source: https://www.svgrepo.com/svg/514067/camera
